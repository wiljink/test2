    ...
    <tr>
      ...
      <td> <!-- ENDORSE link triggers the modal -->
                        <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                            ...
                            data-name="{{$posts->name}}">ENDORSE</a></td>
    </tr>
    @endforeach
  </tbody>
</table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="endorseForm" action="{{ route('posts.store') }}" method="POST">
                    @csrf
                    @method('post')
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="endorseTo" name="endorse_to" required>
                            ...
                            <option value="department_1">Wilson Abecia</option>
                            <option value="department_2">Norwin Megallon</option>
                            <option value="department_3">Ernie Ucang</option>
